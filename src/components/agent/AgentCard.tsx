    ...
    >
      ...
      >
        <div className="flex items-start justify-between mb-3">
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center ${agent.enabled
        ...
        <div className="flex items-center gap-1.5 mb-3">
          ...
          <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-primary-50 text-primary-600 border border-primary-100">
            ...
            <span className="text-[10px] font-bold uppercase tracking-tight">SAFR</span>
          </div>
        </div>
